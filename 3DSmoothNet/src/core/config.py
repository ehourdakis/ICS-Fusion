...
test_arg.add_argument("--evaluate_input_file", type=str, default="./data/evaluate/input_data/input.csv",
                          help='prefix for the input file locations')
test_arg.add_argument("--evaluate_output_file", type=str, default="./data/evaluate/output_data/output.txt",
